...
/** implementation of CardPile class for the simulation
    of a card dealing game.
    @author Jemima Lomax-Sawyers, Reuben Sweetman-Gough, George Zotta
*/

public class CP implements CardPile{

    /** data field representing the pile of cards
        which is altered throughout the various methods.
    */
    ...
    */
    ...
    /** a recursive method to transform the pile based on a given row length
        and specification.
    ...
    */
    ...
    /** method counting the number of transformations
        a pile must go through with a given specification
        in order to get back to the original pile.
        ...
        @return count the number of transformations
        to get back to the original pile
    */
    ...
    */
    ...
    /** main method running the simulation.
        Handles input from the command line or stdin
